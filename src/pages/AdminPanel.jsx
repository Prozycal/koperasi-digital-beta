...
import { FiEdit, FiTrash2, FiShoppingCart, FiList, FiMenu, FiX, FiUsers } from 'react-icons/fi';
        ...
        <nav className="bg-navyDark/90 backdrop-blur-md rounded-3xl shadow-lg shadow-black/20">
            <div className="px-4 py-2">
                ...
                <div className={`md:hidden transition-all duration-300 ease-in-out
                    ${isSidebarOpen ? 'max-h-60 opacity-100 mt-3' : 'max-h-0 opacity-0 invisible'}`}
                >
                ...
                {activeTab === "products" && (
                    <div className="space-y-8 px-4 lg:px-8 max-w-7xl mx-auto">
                        ...
                        <div className="text-left mb-8">
                            ...
                            <p className="text-white/80">Kelola produk koperasi dengan mudah dan efisien</p>
                        </div>
                            ...
                            <table className="min-w-full divide-y divide-white/10">
                                <thead className="bg-white/10">
                                    <tr>
                                        ...
                                        <th className="px-6 py-4 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Harga</th>
                                        <th className="px-6 py-4 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Deskripsi</th>
                ...
                {activeTab === "orders" && (
                    <div className="space-y-8">
                        <div className="text-left mb-8">
                            ...
                            <p className="text-white/80">Kelola pesanan masuk dengan efisien</p>
                        </div>
  ...
  .map((order) => (
    <tr key={order.id}>
      ...
      <td className="px-6 py-4 text-sm text-white">{order.customer}</td>
                                                ...
                                                <td className="px-6 py-4 text-sm text-white">{order.product_name}</td>
